 ...
 */
export declare const changeSubAsyncVDefaultConfig: {
 ...
 */
export declare const changeSubAsyncV: (selector: string, asyncFn?: (p?: unknown) => Promise<unknown>, config?: DeepPartial<typeof changeSubAsyncVDefaultConfig>) => Promise<void>;
