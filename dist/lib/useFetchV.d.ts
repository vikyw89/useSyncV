 ...
 */
export declare const useFetchVDefaultConfig: {
 ...
 */
export declare const useFetchV: (selector: string, asyncFn: () => Promise<unknown>, config?: DeepPartial<typeof useFetchVDefaultConfig>) => {
    data: unknown;
    loading: boolean;
    error: object | null;
};
