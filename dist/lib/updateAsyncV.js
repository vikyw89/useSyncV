            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (config.deleteExistingData) {
                        ...
                        updateSyncV(selector, function (p) { return (__assign(__assign({}, p), { loading: true, error: false })); });
                    }
                    return [4 /*yield*/, asyncFn()];
                case 1:
                    data_1 = _a.sent();
                    // Update synchronous state with new data
                    updateSyncV(selector, function (p) { return (__assign(__assign({}, p), { data: data_1, loading: false })); });
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    // Handle errors
                    updateSyncV(selector, function (p) { return (__assign(__assign({}, p), { loading: false, error: error_1 })); });
                    return [3 /*break*/, 3];
